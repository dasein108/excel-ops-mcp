...
Thin pointer. The canonical, harness-agnostic guide lives in the repo:

- Guide: `agents/skills/excel-ops/SKILL.md` — read this before acting.
- Recipes: `agents/skills/excel-ops/references/cli-workflows.md`.
